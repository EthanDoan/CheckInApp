...
open class SweetAlert: UIViewController {
    ...
    let KTopMargin: CGFloat = 30.0
    let kWidthMargin: CGFloat = 15.0
    let kAnimatedViewHeight: CGFloat = 70.0
    let kMaxHeight: CGFloat = 300.0
    var kContentWidth: CGFloat = 310.0
    let kButtonHeight: CGFloat = 38.0
    ...
    var kTitleFontSize: CGFloat = 16
    var kSubTitleFontSize: CGFloat = 16
    ...
    fileprivate func setupTitleLabel() {
        ...
        titleLabel.font = UIFont(name: kFont, size:kTitleFontSize)
    ...
    fileprivate func setupSubtitleTextView() {
        ...
        subTitleTextView.font = UIFont(name: kFont, size:kSubTitleFontSize)
    ...
    fileprivate func resizeAndRelayout() {
        ...
        for _ in buttons {
            ...
            buttonRect.append(CGRect(x: 0, y: 0, width: 110, height: 30))
        }
        ...
        for i in 0 ..< buttons.count {
            ...
            //buttons[i].layer.cornerRadius = buttons[i].frame.size.height / 2
            buttons[i].layer.cornerRadius = 10
            buttons[i].titleLabel?.font = .fHelveticaNeue(size: 16, type: .Medium)
    ...
    func closeAlert(_ buttonIndex:Int){
        if userAction !=  nil {
            var isOtherButton: Bool = false
            if buttons.count == 2 {
                isOtherButton = buttonIndex != 0 ? true: false
            }
    ...
    open func showAlert(_ title: String, subTitle: String?, titleFontSize: CGFloat = 16, subTitleFontSize: CGFloat = 16, style: AlertStyle, buttonTitle: String, buttonColor: UIColor, otherButtonTitle:
        String?, otherButtonColor: UIColor?, action: ((_ isOtherButton: Bool) -> Void)? = nil) {
        userAction = action
        kTitleFontSize = titleFontSize
        kSubTitleFontSize = subTitleFontSize
    ...
    open func showAlert(_ title: String, subTitle: NSAttributedString?, titleFontSize: CGFloat = 16, subTitleFontSize: CGFloat = 16, style: AlertStyle, buttonTitle: String, buttonColor: UIColor, otherButtonTitle:
        String?, otherButtonColor: UIColor?, action: ((_ isOtherButton: Bool) -> Void)? = nil) {
        userAction = action
        kTitleFontSize = titleFontSize
        kSubTitleFontSize = subTitleFontSize
